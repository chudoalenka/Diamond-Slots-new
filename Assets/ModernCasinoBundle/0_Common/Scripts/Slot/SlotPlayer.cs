...
namespace Mkey
{
    public class SlotPlayer : MonoBehaviour
    {
      ...
      //  [SerializeField]
        private int defCoinsCount = 50000; 
        ...
        #region keys
        private string saveCoinsKey = "Credit"; // current coins
        ...
        private void LoadCoins()
        {
            ...
            //{
                string key = saveCoinsKey;
                SetCoinsCount(PlayerPrefs.GetInt(key,50000));
           // Debug.Log()
           // }
            //else
            //{
        ...
        {
            string key = saveCoinsKey;
            SetCoinsCount(PlayerPrefs.GetInt(key, defCoinsCount));
